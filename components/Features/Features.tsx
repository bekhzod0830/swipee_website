...
export default function Features() {
  ...
  const features = [
    {
      key: 'visualSearch',
      image: '/key_point_images/aI_visual_search.tiff',
      gradient: 'from-purple-500/10 to-pink-500/10',
      iconColor: 'text-purple-600',
    },
    {
      key: 'swipeDiscovery',
      image: '/key_point_images/swipe_discovery.png',
      gradient: 'from-blue-500/10 to-cyan-500/10',
      iconColor: 'text-blue-600',
    },
    {
      key: 'modestFashion',
      image: '/key_point_images/modest_fashion.jpg',
      gradient: 'from-green-500/10 to-emerald-500/10',
      iconColor: 'text-green-600',
    },
    {
      key: 'smartRecommendations',
      image: '/key_point_images/smart_recommendations.jpg',
    ...
    <section id="features" ref={ref} className="py-32 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4">{t('subtitle')}</p>
        </motion.div>
